export { default as MarketDetailAttached } from './marketDetailAttached/marketDetailAttached';
export { default as MarketDetailCar } from './marketDetailCar/marketDetailCar';
export { default as MarketDetailCarousel } from './marketDetailCarousel/marketDetailCarousel';
